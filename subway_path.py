# -*- coding: utf-8 -*-
"""
Created on Wed May 22 16:27:01 2019
...
def ride(here, there, system=boston):
    ...
    return shortest_path_search(here, lambda d: system[d], lambda s: s == there)

def longest_ride(system):
    """"Return the longest possible 'shortest path' 
    ride between any two stops in the system."""
    all_stations = set(system.keys())
    return max((ride(a,b) for a in all_stations for b in all_stations if a!=b),key = len)
